...
func mustStakeEnforcerABI(t *testing.T) abi.ABI {
	t.Helper()
	contractABI, err := abi.JSON(strings.NewReader(`[{"type":"function","name":"BURN","inputs":[],"outputs":[{"name":"","type":"address"}],"stateMutability":"view"},{"type":"function","name":"enforcer","inputs":[],"outputs":[{"name":"","type":"address"}],"stateMutability":"view"}]`))
	if err != nil {
